...
export default function TransporterHeader() {
  ...
  return (
    <header className="w-full bg-white dark:bg-background border-b border-gray-800 dark:border-border shadow flex justify-between items-center px-5 py-3 sticky top-0 z-50">
      {/* Search Bar */}
      ...
      <div className="flex items-center gap-4 ml-6">
        ...
        <div className="relative">
          ...
          <Link
            ...
            className="flex items-center gap-2 p-2 rounded-xl hover:bg-forgr dark:hover:bg-gray-700"
          >
