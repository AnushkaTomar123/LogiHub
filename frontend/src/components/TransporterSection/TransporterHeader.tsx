...
export default function TransporterHeader() {
  ...
  return (
    <header className="w-full bg-white dark:bg-background border-b border-gray-50 dark:border-zinc-700 shadow flex justify-between items-center px-4 py-2 sticky top-0 z-50">
      ...
      <div className="flex-1 max-w-75 hidden md:block">
        <div className="relative">
          <input
            type="text"
            placeholder="Search"
            className="w-full pl-5 pr-4 py-2 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-100 dark:bg-card text-gray-800 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-border"
          />
          <MdSearch
      ...
      <div className="flex items-center gap-3 md:ml-6">
        ...
        <div className="relative">
          ...
          {showNotifications && (
            <div className="absolute right-0 mt-2 w-64 bg-violet-400 dark:bg-card shadow-lg rounded-md p-3 z-50">
